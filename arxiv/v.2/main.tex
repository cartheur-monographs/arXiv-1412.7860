...
\hypersetup{
  pdftitle={A Self-Organizing Geometric Algorithm for Autonomous Data Partitioning},
  pdfauthor={Christopher A. Tucker},
  pdfsubject={Geometric algorithms, autonomous data partitioning, and automata-based structure formation},
  pdfkeywords={geometric algorithm, self-organizing systems, autonomous data partitioning, theory of automata}
}

\raggedbottom

\title{A Self-Organizing Geometric Algorithm for\\
Autonomous Data Partitioning}
...
\paperfigure{figures/fig4.png}{0.72}{The adjacency list by cyclic graph.}
